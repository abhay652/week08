...
variable "kubernetes_version" {
    description = "AKS Kubernetes version. Leave null to let Azure choose the default for the region. Check available versions with: az aks get-versions --location australiaeast --output table"
    type        = string
    default     = null
}
